...
**[Zero Day Broker](https://darknetdiaries.com/episode/98/)**

- The Times Journal IT infrastructure was attacked by Chinese hackers.
- They realized the attack while the hacker was in the system for four months already.
- The interviewee found out that people were asking people to hack her phone and accounts on the dark web.
- A Zero day exploit is a vulnerability that the vendor has not discovered yet.
- Companies sometimes buy zero day vulnerabilities to fix their own software.
- Zero day developer/broker are basically bug hunter that sell the exploit to the one who pay the most (regardless of ethics).
- Corporations would never match grey markets prices (e.g. Apple would pay a few thousands dollar for an IOS access exploit, whereas governments would pay millions).
- NSA often buys zero day exploits.
...
Local parameters in internationalized url treated by Django < 3.2.16 were treated as a regex, meaning that a very long parameter could utilize a lot of CPU resources and cause a denial of service. International URL means translating an url in native language script into ascii text.
...
1. Download MySql *wget https://dev.mysql.com/get/mysql-apt-config_0.8.24-1_all.deb*
